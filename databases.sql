...
--
-- Current Database: `credentialsdb`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `credentialsdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `usercredentials` VALUES ('client','client'),('dataentryuser','dataentryuser'),('root','cgs2545'),('theaccountant','theaccountant');
/*!40000 ALTER TABLE `usercredentials` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'credentialsdb'
--
...
-- Dump completed on 2025-06-02 11:51:55
